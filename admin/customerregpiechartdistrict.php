...
$sql = "SELECT C.dis_name, COUNT(R.cust_id) AS cust_count
        FROM tbl_cust R
...
if ($result) {
        ...
        <script type="text/javascript">
            ...
            function drawChart()
            {
                var data = google.visualization.arrayToDataTable([
                    ...
                    {
                        echo "['" . $display["dis_name"] . "', " . $display["cust_count"] . "],";
                    }
                    ?>
                ]);
                var options = {
                    title: 'Most Registered Customer by District',
                    pieHole: 0.4,
                    slices: {
                        0: { color: 'blue' },
                        1: { color: 'green' },
    ...
    <div style="width: 900px; margin: 0 auto; padding: 20px; background-color: #fff; border-radius: 10px;">
        <h3 align="center">Pie Chart showing the Most Registered customers by  District</h3>
        <br />
