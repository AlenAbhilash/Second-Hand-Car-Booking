...
<div class="container">
    ...
    <div class="row print-button">
        <div class="col-md-6">
       <form action="generate_invoice.php?requestid=<?php echo $request_id ?>&vehicle_id=<?php echo $vehicle_id ?>" method="post">
    <div class="row print-button">
        <div class="col-md-6">
            <p class="lead">THANK YOU!</p>
        </div>
        <div class="col-md-6 text-right">
            <button class="btn btn-success" name="print_invoice"><i class="fa fa-download"></i>Pdf Download</button>
        </div>
    </div>
</form>
