...
<div class="container">
    <h1 class="text-center text-primary text-uppercase mt-5" style="letter-spacing: 5px;">Car</h1>
</div>
 
<div class="container-fluid py-5">
    <div class="container pt-5 pb-3">
        <h1 class="display-4 text-primary text-center">My Car</h1>
                ...
                <?php while ($display = mysqli_fetch_assoc($res)) { ?>
                    <div class="col-lg-4 col-md-6 mb-4">
                        <div class="rent-item">
                            ...
                            <a href="carpaymentt.php?vehicle_id=<?php echo $display["vehicle_id"]; ?>">
                                <button type="button" class="btn btn-primary px-3">Payment Recevied</button>
                            </a>
                        </div>
                    </div>
                <?php } ?>
